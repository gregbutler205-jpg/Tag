...
export default function Header({ logoVisible = true }) {
  ...
  return (
    ...
    >
      {/* Row height is driven by the logo via clamp — elements overflow above/below */}
      <div className="max-w-lg mx-auto flex items-center justify-between"
        style={{ overflow: 'visible' }}>

        {/* Left — Help button */}
        <Link to="/help"
          className="flex flex-col items-center gap-0.5 text-slate-400 hover:text-brand-yellow transition-colors w-16 shrink-0">
